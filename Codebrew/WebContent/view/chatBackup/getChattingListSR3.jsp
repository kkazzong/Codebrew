...
<head>
	...
	<script>
			...
			socket.on('connect', function(){
				...
				socket.on('messageOnList', function(message){
					...
					if(message.command == 'chat') {
						...
						if($("#"+senNick+"List").html() != undefined) {
							//alert("리스트에 존재하는 채팅");
							$("#"+senNick+"List").html(data); 
						} else {
							/////////////추가함//////
							//alert("리스트에 없는 채팅");
							sender = message.sender;
							data = message.data;
							addToNewDiscussion(sender, senNick, data, time);
						}
		...
		/////////////////////////////////////////새로 추가 일대일 채팅 새로운 리스트 html////////////////////////////////////////////
		function addToNewDiscussion(sender, senNick, data, time){
				///////////////recipient는 서버에서 받은걸로
				img = '/resources/image/chat/chat.png';
		...
		//app19 ==> 다중 팝업을 위한 팝업 창 제목 만들기 함수 추가
		var newName =0;
		var n=0;
