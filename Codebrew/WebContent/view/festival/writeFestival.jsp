		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class = "form-group">
					<label for ="festivalDetail" class="col-sm-offset-1 col-sm-3 control-label">내용을 입력하세요</label>
						<div class="col-md-4">
							<textarea rows="5" cols="54" class="form-control" name="festivalDetail">${festival.festivalDetail }</textarea>
						</div>	
				</div>
				...
				<div class = "form-group">
					<label for ="ageLimit" class="col-sm-offset-1 col-sm-3 control-label">연령제한</label>
						<div class="col-md-4">
							<textarea rows="5" cols="54" class="form-control" name="ageLimit">${festival.ageLimit }</textarea>
						</div>	
				</div>
				...
				<div class = "form-group">
					...
					<label for ="bookingPlace" class="col-sm-offset-1 col-sm-3 control-label">예매처</label>
						<div class="col-md-4">
							<textarea rows="5" cols="54" class="form-control" name="bookingPlace">${festival.bookingPlace }</textarea>
						</div>	
				</div>
				...
				<div class = "form-group">
						<label for ="program" class="col-sm-offset-1 col-sm-3 control-label">행사프로그램</label>
							<div class="col-md-4">
								<textarea rows="5" cols="54" class="form-control" name="program">${festival.program }</textarea>
							</div>	
				</div>
				...
				<div class = "form-group">
					<label for ="playTime" class="col-sm-offset-1 col-sm-3 control-label">공연시간</label>
						<div class="col-md-4">
							<textarea rows="5" cols="54" class="form-control" name="playTime">${festival.playTime }</textarea>
						</div>	
				</div>
				...
				<div class = "form-group">
					<label for ="spendTimeFestival" class="col-sm-offset-1 col-sm-3 control-label">관람소요시간</label>
						<div class="col-md-4">
							<textarea rows="5" cols="54" class="form-control" name="spendTimeFestival">${festival.spendTimeFestival }</textarea>
						</div>	
				</div>
			...
			<div class = "form-group">
				<label for ="subEvent" class="col-sm-offset-1 col-sm-3 control-label">부대행사</label>
					<div class="col-md-4">
						<textarea rows="5" cols="54" class="form-control" name="subEvent">${festival.subEvent }</textarea>
					</div>	
			</div>
			...
			<div class = "form-group">
				<label for ="useTimeFestival" class="col-sm-offset-1 col-sm-3 control-label">이용요금</label>
					<div class="col-md-4">
						<textarea rows="5" cols="54" class="form-control" name="useTimeFestival">${festival.useTimeFestival }</textarea>
					</div>	
			</div>
