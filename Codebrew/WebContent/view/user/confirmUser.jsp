	...
	/*  $(function(){
     ...
     $(function(){
		...
		/* 
				$.ajax({
					type:"POST",
					url:"/userRest/json/checkUserId/"+authId,//만약 이런식으로 데이터를 보내면 data:를 안써줘도 됨
				    ...
				    if(JSONData == false){	
	                  ...
	                  $("span.col-id-check").text("이미 가입된 아이디입니다.").css("color","blue");
			...
			success: function(JSONData,status){
				...
				//var authCode2 = JSONData.authCode;
